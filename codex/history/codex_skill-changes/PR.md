# PR Notes: codex_skill-changes

## Summary
Consolidated Codex process docs and tooling into a single-skill, two-template workflow under `codex/`.

## Sprint Plan Reference
- Sprint folder: `codex/history/codex_skill-changes/`
- Plan file: `codex/history/codex_skill-changes/sprint-plan.md`

## Completed Scope
- [x] Single canonical skill at `codex/SKILL.md`.
- [x] Two templates only for plan/PR.
- [x] History stored under `codex/history/<sprint-id>/`.
...
| 2026-02-27 | Updated sprint tooling to use `codex/history` and two required docs. | Match the simplified process contract. | `sprint:start` and `sprint:check` align with desired structure. |
