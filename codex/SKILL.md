...
3. Active sprint/task marker MUST be: `codex/current-sprint.md`
4. One sprint MUST use one git branch.

`codex/current-sprint.md` format MUST be:
...
2. Repository state
3. This `SKILL.md`
4. Current action/task state from `codex/current-sprint.md`
...
6. Set `codex/current-sprint.md` to `<sprint-id>|create_plan_from_prompt|in_progress`.
...
The agent MUST update `codex/current-sprint.md` phase/status when sprint docs are updated.
