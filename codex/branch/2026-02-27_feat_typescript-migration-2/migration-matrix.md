...
| `D04_JournalEngine.gs` | 2048 | 25 | Large mixed engine (I/O + core logic) | Split (high priority) | In progress (2026-02-27): extracted Rule ID assignment + unknown-scenario row-disable transforms to `ts/core`; continue moving pure validation/selection transforms. |
